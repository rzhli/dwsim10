...
Public Interface ISimulationObject
    ...
    ''' <summary>
    ''' If an information carrier object is attached to this object, returns its ID.
    ''' </summary>
    ''' <value></value>
    ''' <returns></returns>
    ''' <remarks></remarks>
    ...
    ''' <summary>
    ''' Checks if an information carrier operation is attached to this object.
    ''' </summary>
    ''' <value></value>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Property IsInfoCarrierAttached() As Boolean
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Property AttachedInfoCarrierId() As String
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Property InfoCarrierVarType() As Enums.SpecVarType

    Property Annotation() As String

    Sub RunDynamicModel()

    Function SaveDynamicState() As Object

    Sub RestoreDynamicState(state As Object)
    ...
    ''' <summary>The editor window of this object, a window of the host's UI framework.</summary>
