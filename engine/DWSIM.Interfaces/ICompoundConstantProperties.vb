...
Public Interface ICompoundConstantProperties
    ...
    ''' </summary>
    ''' <returns></returns>
    Property PF_MM As Double?

    ''' <summary>
    ''' Normal boiling point in K (redundant, deprecated)
    ''' </summary>
    ''' <returns></returns>
    Property NBP As Double?

    ''' <summary>
    ''' Petroleum fraction viscosity A parameter
    ''' </summary>
    ''' <returns></returns>
    Property PF_vA As Double?

    ''' <summary>
    ''' Petroleum fraction viscosity B parameter
    ''' </summary>
    ''' <returns></returns>
    Property PF_vB As Double?

    ''' <summary>
    ''' Petroleum fraction Watson K parameter
    ''' </summary>
    ''' <returns></returns>
    Property PF_Watson_K As Double?

    ''' <summary>
    ''' Petroleum fraction paraffinic mass/mole fraction (0..1) from PNA analysis
    ''' </summary>
    ''' <returns></returns>
    Property PF_xP As Double?

    ''' <summary>
    ''' Petroleum fraction naphthenic mass/mole fraction (0..1) from PNA analysis
    ''' </summary>
    ''' <returns></returns>
    Property PF_xN As Double?

    ''' <summary>
    ''' Petroleum fraction aromatic mass/mole fraction (0..1) from PNA analysis
    ''' </summary>
    ''' <returns></returns>
    Property PF_xA As Double?

    ''' <summary>
    ''' Petroleum fraction refractive index at 20 C (Riazi estimate or measured)
    ''' </summary>
    ''' <returns></returns>
    Property PF_n20 As Double?

    ''' <summary>
    ''' Petroleum fraction refractivity intercept Ri = n20 - d20/2 (Kurtz-Ward)
    ''' </summary>
    ''' <returns></returns>
    Property PF_Ri As Double?

    ''' <summary>
    ''' Petroleum fraction specific gravity
    ''' </summary>
    ''' <returns></returns>
    Property PF_SG As Double?

    ''' <summary>
    ''' Petroleum fraction viscosity value 1
    ''' </summary>
    ''' <returns></returns>
    Property PF_v1 As Double?

    ''' <summary>
    ''' Petroleum fraction temperature for viscosity value 1 in K
    ''' </summary>
    ''' <returns></returns>
    Property PF_Tv1 As Double?

    ''' <summary>
    ''' Petroleum fraction viscosity value 2
    ''' </summary>
    ''' <returns></returns>
    Property PF_v2 As Double?

    ''' <summary>
    ''' Petroleum fraction temperature for viscosity value 1 in K
    ''' </summary>
    ''' <returns></returns>
    Property PF_Tv2 As Double?
