...
Final3:
        ...
        Function BrentOpt2(ByVal minval As Double, ByVal maxval As Double, ByVal n As Integer, ByVal tol As Double, ByVal itmax As Integer, ByVal fx As Func(Of Double, Double)) As Double
            ...
            'a degenerate interval (equal bounds, or a NaN) gives a zero step and the scan below
            'never advances: return the bound itself
            If Not (x_sup - x_inf > 0.0) Then Return x_inf
            ...
            Do
                ...
                y_inf = fx(x_inf)
                scanCount += 1
            Loop Until y * y_inf < 0 Or x_inf >= x_sup Or scanCount > n
            x_sup = x_inf - delta_x
