...
''' <summary>
''' Defines the units of measure system used throughout DWSIM, including unit conversion utilities
''' and multiple measurement system definitions (SI, CGS, English, etc.).
''' </summary>
