...
''' <summary>
''' Contains core flowsheet data structures, event arguments, and message types shared across
''' DWSIM's user interface and simulation engine layers.
''' </summary>
Namespace DWSIM.Flowsheet
    ...
    <System.Serializable()> Public Class FlowsheetVariables
        ...
        Sub New()
            ...
            SelectedUnitSystem = New SystemsOfUnits.SI_ENG()
        ...
        Public Property InformationCarrierCalculationMode As SpecCalcMode = SpecCalcMode.AfterSourceObject Implements IFlowsheetOptions.InformationCarrierCalculationMode

        Public Property Metadata As IFlowsheetMetadata = New FlowsheetMetadata Implements IFlowsheetOptions.Metadata

        Public Property CurrentFlowsheetObjectZoomLevel As Double = 1.0 Implements IFlowsheetOptions.CurrentFlowsheetObjectZoomLevel
