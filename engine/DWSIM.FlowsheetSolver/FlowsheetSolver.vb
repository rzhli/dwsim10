...
<System.Serializable()> Public Class FlowsheetSolver
                        ...
                        Else
                            If objArgs.Calculated = True Then
                                ...
                                For Each utility In myUnitOp.AttachedUtilities
                                    If utility.AutoUpdate Then
                                        fbag.RunCodeOnUIThread(Sub()
                                                                   Try
                                                                       utility.Update()
    ...
    Public Shared Function SolveFlowsheet(ByVal fobj As Object, mode As Integer, Optional ByVal ts As CancellationTokenSource = Nothing,
        ...
        If GlobalSettings.Settings.CalculatorActivated Then
            ...
            fs.Solved = False
            fs.ErrorMessage = ""
            fs.ErrorMessages = New List(Of Exception)()
            ...
            If age Is Nothing Then
                ...
                fs.FlowsheetOptions.Metadata.Score = Evaluation.GetScore(fs)

                If Not Settings.AutomationMode Then Task.Run(Sub() fs.SaveCurrentStateAsLastSuccessfulSolution())
            ...
            Else
                ...
                For Each ex In age.Flatten().InnerExceptions
                    ...
                    Else
                        ...
                        End While
                    End If
                    fs.ErrorMessages.Add(baseexception)
                ...
                fs.FlowsheetOptions.Metadata.Score = -(Date.Now - d1).TotalSeconds
