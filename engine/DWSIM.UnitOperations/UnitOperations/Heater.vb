...
Namespace UnitOperations
    ...
    ''' </summary>
    <System.Serializable()> Public Partial Class Heater
        ...
        ''' <summary>Creates the dimensions list used for equipment sizing (Power).</summary>
        ...
        ''' <summary>Updates the Power dimension value from the current heat duty.</summary>
        ...
        ''' <summary>Defines the calculation modes available for the heater.</summary>
        Public Enum CalculationMode
            ''' <summary>Outlet conditions calculated from a specified heat duty (kW).</summary>
            HeatAdded = 0
            ''' <summary>Heat duty calculated to achieve the specified outlet temperature.</summary>
            OutletTemperature = 1
            ''' <summary>Heat duty read from the connected energy stream.</summary>
            EnergyStream = 2
            ''' <summary>Heat duty calculated to achieve the specified outlet vapor mole fraction.</summary>
            OutletVaporFraction = 3
            ''' <summary>Heat duty calculated to achieve the specified temperature change.</summary>
            TemperatureChange = 4
            ''' <summary>Heat added or removed (for mobile compatibility).</summary>
            HeatAddedRemoved = 5
        End Enum
        ...
        ''' <summary>Gets or sets whether the solver fixes on heat duty when convergence fails (not used in normal mode).</summary>
        ...
        ''' <summary>
        ''' Initializes a new instance of the <see cref="Heater"/> class with a name and description.
        ''' </summary>
        ''' <param name="name">The display name of the heater.</param>
        ''' <param name="description">A brief description of the heater.</param>
        ...
        ''' <summary>Gets or sets the heater efficiency as a percentage (0–100). Determines how much of the specified heat duty is actually transferred to the stream.</summary>
        ...
        ''' <summary>Gets or sets the target outlet vapor mole fraction used when <see cref="CalcMode"/> is <see cref="CalculationMode.OutletVaporFraction"/>.</summary>
        ...
        ''' <summary>Gets or sets the target outlet temperature (K) used when <see cref="CalcMode"/> is <see cref="CalculationMode.OutletTemperature"/>.</summary>
        ...
        ''' <summary>Gets or sets the active calculation mode that determines which variables are specified and which are calculated.</summary>
        ...
        ''' <summary>Gets or sets the pressure drop across the heater (Pa). Outlet pressure = inlet pressure - DeltaP.</summary>
        ...
        ''' <summary>Gets or sets the calculated or specified temperature change across the heater (K).</summary>
        ...
        ''' <summary>Gets or sets the heat duty added to the stream (kW). Positive = heating.</summary>
        ...
        ''' <summary>Gets or sets the heat duty (kW) as a plain Double proxy for <see cref="DeltaQ"/>.</summary>
        ...
        ''' <summary>Gets or sets the efficiency (%) as a plain Double proxy for <see cref="Eficiencia"/>.</summary>
        ...
        ''' <summary>Gets or sets the pressure drop (Pa) as a plain Double proxy for <see cref="DeltaP"/>.</summary>
        ...
        ''' <summary>Gets or sets the temperature change (K) as a plain Double proxy for <see cref="DeltaT"/>.</summary>
        ...
        ''' <summary>Initializes a new default instance of the <see cref="Heater"/> class.</summary>
        Public Sub New()
            MyBase.New()
        End Sub

        ''' <summary>Creates a deep copy of this heater via XML serialization.</summary>
        ...
        ''' <summary>Executes the heater dynamic model for one integration time step, updating accumulation, temperature, and pressure.</summary>
        Public Overrides Sub RunDynamicModel()
            ...
            Dim Twall As Double = GetDynamicProperty("Wall Temperature")

            If WallMCp > 0 Then

                Dim Qamb As Double = 0.0
                If UA > 0 Then Qamb = UA * (Tambient - Twall) / 1000.0

                Dim QtoFluid As Double = 0.0
                If Wa > 0 Then
                    Dim Tfluid = AccumulationStream.GetTemperature()
                    QtoFluid = UA * (Twall - Tfluid) / 1000.0
                End If

                Twall = Twall + (Qsource * 1000.0 + Qamb * 1000.0 - QtoFluid * 1000.0) * timestep / WallMCp
                SetDynamicProperty("Wall Temperature", Twall)
            ...
            Else
                ...
                If UA > 0 AndAlso Wa > 0 Then
                    Dim Qamb = UA * (Tambient - AccumulationStream.GetTemperature()) / 1000.0
                    Qval += Qamb
                End If
        ...
        ''' <summary>
        ''' Performs the steady-state heater calculation according to <see cref="CalcMode"/>.
        ''' Computes outlet enthalpy, temperature, vapor fraction, and heat duty from the inlet stream and specified parameters.
        ''' </summary>
        ...
        ''' <param name="prop">The property identifier string (e.g., "PROP_HT_0").</param>
        ...
        ''' <summary>Returns the list of property identifiers available for this heater.</summary>
        ...
        ''' <summary>Returns the raw bytes of the heater icon image resource.</summary>
        ...
        ''' <summary>Returns the localized display description for the heater type.</summary>
        ''' <returns>A localized description string.</returns>
        Public Overrides Function GetDisplayDescription() As String
            Return ResMan.GetLocalString("HEAT_Desc")
        End Function

        ''' <summary>Returns the localized display name for the heater type.</summary>
        ...
        ''' <summary>Generates a text report summarizing the heater's inlet, outlet, and calculation parameters.</summary>
