...
Namespace UnitOperations
    ...
    ''' </summary>
    <System.Serializable()> Public Partial Class Cooler
        ...
        ''' <summary>Gets the list of equipment sub-types available for this cooler.</summary>
        ...
        ''' <summary>Creates the dimensions list used for equipment sizing (Area).</summary>
        ...
        ''' <summary>Updates the dimensions list (no-op for the cooler).</summary>
        Public Overrides Sub UpdateDimensionsList()


        End Sub

        ''' <summary>Defines the calculation modes available for the cooler.</summary>
        Public Enum CalculationMode
            ''' <summary>Outlet conditions calculated from a specified heat removal duty (kW).</summary>
            HeatRemoved = 0
        ...
        ''' <summary>
        ''' Initializes a new instance of the <see cref="Cooler"/> class with a name and description.
        ''' </summary>
        ''' <param name="name">The display name of the cooler.</param>
        ''' <param name="description">A brief description of the cooler.</param>
        ...
        ''' <summary>Creates a deep copy of this cooler via XML serialization.</summary>
        ...
        ''' <summary>Gets or sets the pressure drop across the cooler (Pa). Outlet pressure = inlet pressure - DeltaP.</summary>
        ...
        ''' <summary>Gets or sets the calculated or specified temperature change across the cooler (K).</summary>
        ...
        ''' <summary>Gets or sets the heat duty removed from the stream (kW). Positive = cooling.</summary>
        ...
        ''' <summary>Initializes a new default instance of the <see cref="Cooler"/> class.</summary>
        Public Sub New()
            MyBase.New()
        End Sub
        ...
        ''' <summary>Executes the cooler dynamic model for one integration time step, updating accumulation, temperature, and pressure.</summary>
        ...
        ''' <summary>
        ''' Performs the steady-state cooler calculation according to <see cref="CalcMode"/>.
        ''' Computes outlet enthalpy, temperature, vapor fraction, and heat removal duty from the inlet stream and specified parameters.
        ''' </summary>
        ...
        ''' <param name="prop">The property identifier string (e.g., "PROP_CL_0").</param>
        ...
        ''' <summary>Returns the list of property identifiers available for this cooler.</summary>
        ...
        ''' <summary>Returns the raw bytes of the cooler icon image resource.</summary>
        ...
        ''' <summary>Returns the localized display description for the cooler type.</summary>
        ''' <returns>A localized description string.</returns>
        Public Overrides Function GetDisplayDescription() As String
            Return ResMan.GetLocalString("COOL_Desc")
        End Function

        ''' <summary>Returns the localized display name for the cooler type.</summary>
        ...
        ''' <summary>Generates a text report summarizing the cooler's inlet, outlet, and calculation parameters.</summary>
