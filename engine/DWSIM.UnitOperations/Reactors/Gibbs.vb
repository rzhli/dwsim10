...
Namespace Reactors
    ...
    ''' </summary>
    <System.Serializable()> Public Partial Class Reactor_Gibbs
        ...
        ''' <summary>Gets or sets whether the IPOPT solver is used for the Gibbs minimisation.</summary>
        ...
        Public Enum SolvingMethod
            ''' <summary>Minimise Gibbs energy along defined reaction-extent coordinates.</summary>
            ReactionExtents = 0
            ''' <summary>Direct minimisation of Gibbs energy subject to elemental balance constraints.</summary>
        ...
        ''' <summary>Defines which phases participate in the Gibbs minimisation.</summary>
        Public Enum ReactivePhaseType
            ''' <summary>Phase equilibrium is calculated along with the chemical equilibrium.</summary>
            CalculateEquilibrium = 0
            ''' <summary>Reactions occur only in the vapour phase.</summary>
            Vapor = 1
            ''' <summary>Reactions occur only in the liquid phase.</summary>
            Liquid = 2
            ''' <summary>Reactions occur only in the solid phase.</summary>
            Solid = 3
        End Enum

        ''' <summary>Gets or sets the reactive-phase behaviour for the Gibbs minimisation.</summary>
        Public Property ReactivePhaseBehavior As ReactivePhaseType = ReactivePhaseType.CalculateEquilibrium

        ''' <summary>Initializes a new default instance of the <see cref="Reactor_Gibbs"/> class.</summary>
        Public Sub New()
            MyBase.New()
        End Sub
        ...
        ''' <summary>Serializes the reactor state, including element matrices and compound lists, to XML.</summary>
...
#Region "Properties"
        ...
        ''' <summary>Gets or sets whether the solver initialises from the previous converged solution.</summary>
        Public Property InitializeFromPreviousSolution As Boolean = True

        ''' <summary>Gets or sets the list of variable values from the previous solution, used for warm-starting.</summary>
        Public Property PreviousSolution As New List(Of Double)

        ''' <summary>Gets or sets whether damping is applied to the Newton step during the Lagrange method iteration.</summary>
        Public Property EnableDamping As Boolean = True

        ''' <summary>Gets or sets the lower bound for the damping factor.</summary>
        Public Property DampingLowerLimit As Double = 0.001

        ''' <summary>Gets or sets the upper bound for the damping factor.</summary>
        Public Property DampingUpperLimit As Double = 2.0

        ''' <summary>Gets or sets the relative perturbation used for numerical derivative estimation.</summary>
        Public Property DerivativePerturbation As Double = 0.0001

        ''' <summary>Gets or sets the maximum number of iterations for the inner minimisation loop.</summary>
        Public Property MaximumInternalIterations As Integer = 1000

        ''' <summary>Gets or sets the convergence tolerance for the inner minimisation loop.</summary>
        Public Property InternalTolerance As Double = 1.0E-20

        ''' <summary>Gets or sets the temperature (K) used to estimate initial Lagrange coefficients.</summary>
        Public Property LagrangeCoeffsEstimationTemperature As Double = 1000.0

        ''' <summary>Gets or sets the initial total Gibbs free energy before minimisation.</summary>
        ...
        ''' <summary>Gets or sets the final total Gibbs free energy after minimisation.</summary>
        ...
        ''' <summary>Gets or sets the relative element balance error after convergence.</summary>
        Public Property ElementBalance As Double = 0.0

        ''' <summary>Gets the dictionary of calculated reaction extents, keyed by reaction ID.</summary>
        ...
        ''' <summary>Gets or sets the array of chemical element symbols involved in the minimisation.</summary>
        ...
        ''' <summary>Gets or sets the list of compound IDs used in direct minimisation.</summary>
        ...
        ''' <summary>Gets or sets the list of compound IDs used in reaction-extent mode.</summary>
        ...
        ''' <summary>Gets or sets the list of user-supplied initial estimates for the minimisation variables.</summary>
        ...
        ''' <summary>Gets or sets the element–compound formula matrix used for elemental balance constraints.</summary>
        ...
        ''' <summary>Gets or sets the array of total element amounts (mol) in the feed.</summary>
...
#Region "Auxiliary Subs"
        ...
        ''' <summary>Validates and updates the compound ID list, removing compounds no longer present in the simulation.</summary>
        ...
        ''' <summary>
        ''' Builds the element–compound formula matrix from the compound database, identifying
        ''' which chemical elements are present and their stoichiometric counts per compound.
        ''' </summary>
...
#End Region
        ...
        ''' <summary>
        ''' Initializes a new instance of the <see cref="Reactor_Gibbs"/> class with a name and description.
        ''' </summary>
        ''' <param name="name">The display name of the Gibbs reactor.</param>
        ''' <param name="description">A brief description of the Gibbs reactor.</param>
        ...
        ''' <summary>Executes one dynamic simulation time step for the Gibbs reactor.</summary>
        ...
        ''' <summary>
        ''' Performs the Gibbs reactor calculation, delegating to either direct minimisation
        ''' or Lagrange multiplier method depending on the selected solving approach.
        ''' </summary>
        ...
        ''' <summary>Solves the Gibbs minimisation using IPOPT or simplex subject to elemental balance constraints.</summary>
        ...
        ''' <summary>Solves the Gibbs minimisation using the Lagrange multiplier (simultaneous correction) method.</summary>
