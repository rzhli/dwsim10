...
Namespace Reactors
    ...
    ''' </summary>
    <System.Serializable()> Public Partial Class Reactor_Conversion
        ...
        ''' <summary>Gets a value indicating whether this reactor has no dedicated dynamic-mode properties.</summary>
        ...
        ''' <summary>
        ''' Initializes a new instance of the <see cref="Reactor_Conversion"/> class with a name and description.
        ''' </summary>
        ''' <param name="name">The display name of the conversion reactor.</param>
        ''' <param name="description">A brief description of the conversion reactor.</param>
        ...
        ''' <summary>Registers the dynamic properties (operating pressure, liquid level, volume, etc.) for dynamic simulation mode.</summary>
        ...
        ''' <summary>Executes one dynamic simulation time step, integrating mass flows and updating accumulation.</summary>
        ...
        ''' <summary>
        ''' Performs the conversion reactor calculation: applies each conversion reaction in sequence,
        ''' computes the product composition and energy balance, and flashes the outlet stream.
        ''' </summary>
