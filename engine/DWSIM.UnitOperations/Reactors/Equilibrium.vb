...
Namespace Reactors
    ...
    ''' </summary>
    <System.Serializable()> Public Partial Class Reactor_Equilibrium
...
#Region "Properties"
        ...
        ''' <summary>Gets or sets the initial total Gibbs free energy of the system (kJ/mol) before reaction.</summary>
        Public Property InitialGibbsEnergy As Double = 0.0

        ''' <summary>Gets or sets the final total Gibbs free energy of the system (kJ/mol) after reaction.</summary>
        Public Property FinalGibbsEnergy As Double = 0.0

        ''' <summary>Gets or sets the dictionary of calculated reaction extents, keyed by reaction ID.</summary>
        Public Property ReactionExtents As New Dictionary(Of String, Double)

        ''' <summary>Gets or sets the dictionary of reaction extents from the previous iteration, used for warm-starting.</summary>
        Public Property PreviousReactionExtents As New Dictionary(Of String, Double)

        ''' <summary>Gets or sets the list of compound IDs participating in the equilibrium reactions.</summary>
        Public Property ComponentIDs As New List(Of String)

        ''' <summary>Gets or sets whether the solver uses the previous solution as a starting point.</summary>
        Public Property UsePreviousSolution As Boolean = False

        ''' <summary>Gets or sets the convergence tolerance for the inner (reaction-extent) optimisation loop.</summary>
        Public Property InternalLoopTolerance As Double = 0.001

        ''' <summary>Gets or sets the convergence tolerance for the outer (energy-balance) iteration loop.</summary>
        Public Property ExternalLoopTolerance As Double = 0.01

        ''' <summary>Gets or sets the maximum number of iterations for the inner optimisation loop.</summary>
        Public Property InternalLoopMaximumIterations As Integer = 1000

        ''' <summary>Gets or sets the maximum number of iterations for the outer energy-balance loop.</summary>
        Public Property ExternalLoopMaximumIterations As Integer = 50

        ''' <summary>Gets or sets whether the IPOPT solver is used for the optimisation (otherwise a simplex method is used).</summary>
...
#End Region
        ...
        ''' <summary>
        ''' Initializes a new instance of the <see cref="Reactor_Equilibrium"/> class with a name and description.
        ''' </summary>
        ''' <param name="name">The display name of the equilibrium reactor.</param>
        ''' <param name="description">A brief description of the equilibrium reactor.</param>
        ...
        ''' <summary>Executes one dynamic simulation time step for the equilibrium reactor.</summary>
        ...
        ''' <summary>
        ''' Performs the equilibrium reactor calculation by minimising Gibbs free energy along
        ...
        ''' <summary>Internal solver that minimises Gibbs energy using IPOPT or simplex to find the equilibrium extents.</summary>
        ...
        ''' <summary>Solves the equilibrium reactions using a successive-relaxation approach, processing reactions one at a time.</summary>
        ...
        ''' <summary>Legacy internal solver method retained for backward compatibility.</summary>
        ...
        ''' <summary>Restores the reactor state, including reaction extents and component IDs, from XML.</summary>
