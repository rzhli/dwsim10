...
Namespace UnitOperations.CAPEOPENWrappers
    ...
    <Guid(CO_CustomUO.ClassId)> <System.Serializable()> <ComVisible(True)> Partial Public Class CO_CustomUO
        ...
        Public Overrides Sub CreateParameters()
            ...
            ' the font families the script editor can be set to; SkiaSharp reads them from
            ' whatever font manager the platform has, where GDI+ only knows about Windows
            For Each family In SkiaSharp.SKFontManager.Default.GetFontFamilies()
        ...
        Public Overrides Sub Calculate()
            ...
            If _interpreter = "IronPython" Then
                ...
                Catch ex As Exception
                    ...
                    Console.WriteLine(Me.ComponentName & ": " & _lastrun)
        ...
        ''' <summary>
        ''' Opens the script editor. Does nothing where the WinForms editors are not built.
        ''' </summary>
