...
''' <summary>
''' Provides plug-in classes that expose low-level thermodynamic calculation routines (fugacity coefficients,
''' departure functions) for reuse across multiple property packages.
''' </summary>
