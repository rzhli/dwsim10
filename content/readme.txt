...
- [NEW] Pump: positive displacement calculation mode (displacement, volumetric efficiency, relief setting; the flow set by the speed, the pressure by the line); in dynamics the delivered flow follows the drive speed; dosing example in the case library
